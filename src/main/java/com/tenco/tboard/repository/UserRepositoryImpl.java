...
public class UserRepositoryImpl implements UserRepository{
	...
	private static final String SELECT_USER_BY_USERNAME_ANA_PASSWORD =" SELECT * FROM users WHERE username = ? AND password = ? ";
	...
	@Override
	public User getUserByusernameAndPssword(String username, String password) {
		User user  = null;
		try (Connection conn = DBUtil.getConnection();
			PreparedStatement pstmt = conn.prepareStatement(SELECT_USER_BY_USERNAME_ANA_PASSWORD)){
