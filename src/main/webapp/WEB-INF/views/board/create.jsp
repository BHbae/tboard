...
<body>
	...
	<form action="${pageContext.request.contextPath}/board/create" method="post">
		<div class="form-group">
			...
			<input type="text" id="title" name="title" value="코딩테스트 연습"> 
		</div>
		...
		<div class="form-group">
			...
			<a href="${pageContext.request.contextPath}/board/list?page=1" class="btn btn-back">돌아가기</a>		
		</div>
